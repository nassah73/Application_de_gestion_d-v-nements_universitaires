        ...
        <div className="p-8">
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8">
                      ...
                      <div className="space-y-4">
                        <div className="space-y-2">
                          ...
                          <input 
                            ...
                            className="w-full bg-[#0f1117] border border-white/10 rounded-xl px-4 py-3 outline-none focus:border-[#f97316] transition-all text-white"
            ...
            <div className="lg:col-span-5 text-left">
              <h2 className="text-xl font-bold mb-6 flex items-center gap-2 text-white">Aperçu en Direct</h2>
              <AnimatePresence mode="wait">
                {category ? (
                  <motion.div 
                    key={category}
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      ...
                      <h3 className="text-2xl font-bold pr-12 leading-tight text-white">{newsData.title || "Le titre s'affiche ici"}</h3>
