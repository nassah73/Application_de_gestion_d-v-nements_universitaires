...
const UserManagement = () => {
  ...
  const columns = [
    ...
    { field: "name", headerName: "Nom complet", flex: 1, cellClassName: "name-column--cell" },
    ...
    <Box sx={{ p: "24px", height: "100%", display: "flex", flexDirection: "column", backgroundColor: colors.primary[500] }}>
      ...
      <Box sx={{ mb: "20px", display: "flex", gap: "10px" }}>
        <TextField
          ...
          InputProps={{ startAdornment: <SearchIcon sx={{ mr: 1, color: colors.grey[400] }} /> }}
          sx={{ width: "350px", "& .MuiFilledInput-root": { backgroundColor: colors.primary[400] } }}
        />
      </Box>
      ...
      <Box
        sx={{
          ...
          "& .MuiDataGrid-cell": { borderBottom: `1px solid ${colors.grey[800]}`, color: colors.grey[100], display: "flex", alignItems: "center" },
      ...
      >
        ...
        <DialogContent sx={{ pt: "20px !important" }}>
          <Box sx={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            <TextField
              fullWidth label="Nom complet" variant="filled" value={formData.name}
              onChange={(e) => setFormData({ ...formData, name: e.target.value })}
              sx={{ "& .MuiFilledInput-root": { backgroundColor: colors.primary[500] } }}
            />
            <TextField
              fullWidth label="Email" variant="filled" value={formData.email}
              onChange={(e) => setFormData({ ...formData, email: e.target.value })}
              sx={{ "& .MuiFilledInput-root": { backgroundColor: colors.primary[500] } }}
            />
            <TextField
              fullWidth label="Rôle" variant="filled" value={formData.role}
              onChange={(e) => setFormData({ ...formData, role: e.target.value })}
              sx={{ "& .MuiFilledInput-root": { backgroundColor: colors.primary[500] } }}
            />
            <FormControl fullWidth variant="filled">
              <InputLabel>Niveau d'accès</InputLabel>
              <Select value={formData.access} onChange={(e) => setFormData({ ...formData, access: e.target.value })} sx={{ backgroundColor: colors.primary[500] }}>
        ...
        <DialogActions sx={{ p: 3 }}>
          ...
          <Button onClick={handleSave} variant="contained" sx={{ backgroundColor: colors.greenAccent[600], color: "white", px: 4, borderRadius: "8px" }}>
      ...
      <Dialog
        ...
        slotProps={{ paper: { sx: { backgroundColor: colors.primary[400], color: colors.grey[100], borderRadius: "16px" } } }}
      >
