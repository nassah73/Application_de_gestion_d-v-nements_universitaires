      ...
      >
        ...
        >
          <Box sx={{ mb: "25px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <Box>
              <Typography variant="h3" sx={{ fontWeight: 800, color: colors.grey[100], mb: "4px" }}>
          ...
          <Box sx={{ width: "100%", height: "300px" }}>
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={attendanceData}>
                ...
                <Tooltip
                  contentStyle={{ backgroundColor: colors.primary[400], border: `1px solid ${colors.grey[700]}`, borderRadius: "12px" }}
                />
        ...
        >
          <Typography variant="h3" sx={{ fontWeight: 800, color: colors.grey[100], mb: "20px" }}>
        ...
        >
          ...
          <Box sx={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            {recentActivities.map((activity) => (
              ...
              >
                <Box>
                  <Typography variant="h5" sx={{ fontWeight: 700, color: colors.greenAccent[500] }}>
                    {activity.user}
                  </Typography>
                ...
                <Typography variant="h6" sx={{ color: colors.grey[400], fontStyle: "italic" }}>
                  {activity.time}
                </Typography>
              </Box>
            ))}
