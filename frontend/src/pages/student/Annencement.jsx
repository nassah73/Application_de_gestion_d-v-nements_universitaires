...
const AnnouncementCard = ({ tag, tagColor, date, title, description, type, primaryAction, secondaryAction }) => (
  <div className="bg-white/5 backdrop-blur-xl rounded-[2.5rem] p-8 shadow-sm border border-white/10 hover:shadow-lg transition-all relative text-left">
    ...
    <div className="flex flex-col gap-4">
      ...
      <h3 className="text-2xl font-bold text-white leading-tight pr-12">{title}</h3>
      <p className="text-slate-300 leading-relaxed text-lg mb-4">{description}</p>
      ...
      <div className="min-h-screen bg-slate-900 p-4 md:p-8 pt-[100px] font-sans">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-9 space-y-6 text-left">
              ...
              <div className="flex flex-col md:flex-row gap-6 relative z-10">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-slate-300 text-sm font-medium">April 13, 2026 • 08:30 AM</span>
                  </div>
                  <h2 className="text-2xl font-black text-white mb-4 leading-tight">Emergency Weather Alert: Basketball Championship Postponed</h2>
            ...
            <AnnouncementCard 
              tag="Club Alert"
              tagColor="bg-[#cd7329]/20 text-[#cd7329] border-[#cd7329]/20"
